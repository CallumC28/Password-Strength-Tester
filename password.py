...
# "C:\Users\cccin\AppData\Roaming\Python\Python313\Scripts\pyinstaller.exe" --onefile --windowed --hidden-import=zxcvbn C:\xampp\htdocs\Final_Year_Project\password.py